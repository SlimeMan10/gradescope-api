      ...
      >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button 
              ...
              className="w-full mt-4 text-sm text-purple-600 hover:text-purple-800 transition-colors text-center focus-accessible focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 animate-slideUp"
              style={{animationDelay: '400ms'}}
              aria-label="Clear storage and reload the page"
            >
